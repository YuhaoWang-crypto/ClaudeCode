...
gpu_image = (
    ...
    .run_commands(
        ...
        "# (1) pin CUDA toolkit to 12.4: 13.3 breaks torch2.6/flash-attn2.7, and\n"
        "#     12.9 makes proto-tools pick a cu128 torch index lacking torch==2.6.0\n"
        "#     (ships cu124/cu126). 12.4 -> cu124 index + matches torch's cu124 build.\n"
